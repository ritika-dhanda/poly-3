...
└── SnarkVerifier.sol
```
Verifier contracts are autogenerated and prefixed by the circuit name, in this example **Multiplier** But i have renamed it as "Snark"
...
[
  {
    "name": "Snark",
    "protocol": "groth16",
    "circuit": "Snark/circuit.circom",
    "input": "Snark/input.json",
    "wasm": "Snark/out/circuit.wasm",
    "zkey": "Snark/out/Snark.zkey",
    "vkey": "Snark/out/Snark.vkey",
    "r1cs": "Snark/out/Snark.r1cs",
